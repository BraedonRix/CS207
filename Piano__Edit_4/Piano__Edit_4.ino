...
int neverGoinToNotes[] = {
  NOTE_AS3, NOTE_C4, NOTE_CS4, NOTE_AS3, NOTE_F4, NOTE_F4, NOTE_DS4, NOTE_GS3, NOTE_AS3, NOTE_C4, NOTE_GS3, NOTE_DS4,
  NOTE_DS4, NOTE_CS4, NOTE_C4, NOTE_AS3, NOTE_AS3, NOTE_C4, NOTE_CS4, NOTE_AS3, NOTE_CS4, NOTE_DS4, NOTE_C4, NOTE_AS3,
  NOTE_GS3, NOTE_F3, NOTE_DS4, NOTE_CS4, NOTE_AS4, NOTE_C4, NOTE_CS4, NOTE_AS4, NOTE_F4, NOTE_F4, NOTE_DS4, NOTE_GS3,
  NOTE_AS4, NOTE_C4, NOTE_GS3, NOTE_GS4, NOTE_C4, NOTE_CS4, NOTE_C4, NOTE_AS3, NOTE_GS3, NOTE_AS3, NOTE_C4, NOTE_GS3,
  NOTE_CS4, NOTE_DS4, NOTE_C4, NOTE_AS3, NOTE_GS3, NOTE_F3, NOTE_DS4, NOTE_CS4,
};
...
int neverGoingToDuration[] = {
  6, 4, 6, 6, 2, 2, 2, 6, 6, 4, 6, 4,
  4, 4, 4, 4, 6, 4, 6, 6, 6, 4, 5.5, 4, 5.5,
  4, 4, 4, 2, 6, 4, 6, 6, 4, 4, 2, 6,
  6, 6, 4, 6, 4, 4, 4, 4, 4, 6, 6, 4,
  6, 4, 5.5, 4, 5.5, 4, 4, 4, 2,
...
const int playlist = 0; //Switch between modes
...
void setup()
{
  ...
  pinMode(BUTTON_CS, INPUT);  //Added the pinMode and digitalWrite for the new button
...
//Each button plays a song
  if (value >= 341 && value <= 682)
  {
    ...
    while(digitalRead(BUTTON_AS) == ACTIVATED)
    {
      ...
      for (int s = 0; s < 85; s++)
      {
        int noteDuration3 = 600 / sovietDuration[s];
        tone(11, sovietNotes[s], noteDuration3);
        int pauseBetweenNotes3 = noteDuration3 * 1.50;
...
//Plays all songs in a loop
  if (value >= 683)
  {
    for (int z = 0; z < 85; z++)  //Never Going To Give You Up
    {
      for (int y = 0; y < 85; y++)  //All Star
      {
        for (int x = 0; x < 85; x++) //Soviet Anthem
        {
          for (int w = 0; w < 85; w++)  //Mii Channel Theme
          {
            for (int v = 0; v < 85; v++)  //Africa
            {
          ...
          int noteDuration3 = 600 / sovietDuration[x];
          tone(11, sovietNotes[x], noteDuration3);
          int pauseBetweenNotes3 = noteDuration3 * 1.50;
          delay(pauseBetweenNotes3);
          noTone(11);
        }
